...
public class LettuceConnectionConfigure extends RedisConnectionConfiguration {
    ...
    public LettuceConnectionConfigure(RedisProperties properties,
    ...
    private LettuceClientConfigurationBuilder createBuilder(Pool pool) {
        ...
        return new LettuceConnectionConfigure.PoolBuilderFactory().createBuilder(pool);
    }
    ...
    private void customizeConfigurationFromUrl(LettuceClientConfiguration.LettuceClientConfigurationBuilder builder) {
        LettuceConnectionConfigure.ConnectionInfo connectionInfo = parseUrl(getProperties().getUrl());
